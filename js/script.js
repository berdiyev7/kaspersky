...
$(window).on('load resize', function () {
   if ($(window).width() < 979) {
      $('.slider-show:not(.slick-initialized)').slick({
         dots: true,
         infinite: false,
         slidesToShow: 1,
         slidesToScroll: 1,
      ...
      $(".slider-show.slick-initialized").slick("unslick")
   }

   if ($(window).width() < 607) {
      $('.order-show:not(.slick-initialized)').slick({
         dots: true,
         infinite: false,
         slidesToShow: 1,
         slidesToScroll: 1,
      ...
      $(".order-show.slick-initialized").slick("unslick")
   }
